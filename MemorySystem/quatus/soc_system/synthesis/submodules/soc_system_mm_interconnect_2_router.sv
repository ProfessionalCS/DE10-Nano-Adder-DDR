...
(
    ...
    localparam PAD3 = log2ceil(64'h28 - 64'h20); 
    // -------------------------------------------------------
    ...
    // ( 0x18 .. 0x20 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 6'h18  && write_transaction  ) begin
            src_channel = 4'b0010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x20 .. 0x28 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 6'h20  && write_transaction  ) begin
            src_channel = 4'b0001;
